...
Gesundheitstechnologie, insbesondere Health Information Technology (HIT) wie elektronische Gesundheitsakten (EHR), klinische Entscheidungsunterstützung und Health Information Exchange (HIE), verbessert die Qualität, Effizienz und Kosten der medizinischen Versorgung. Studien zeigen, dass HIT Medikationsfehler reduziert und die Einhaltung leitlinienbasierter Versorgung fördert. [@Chaudhry2006;@Jones2014] Gesundheitsdatenaustausch optimiert die Kommunikation und senkt administrative Kosten. [@Sadoughi2018] Kosteneinsparungen variieren jedoch je nach Implementierung, [@Low2013] wobei mögliche kurzfristige Kostensteigerungen auftreten können. [@Agha2014] Die Wirksamkeit von HIT hängt stark von Systemauswahl und Versorgungsumfeld ab. [@Buntin2011;@Baillieu2020;@McCullough2010]
