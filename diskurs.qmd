...
### [digitalversorgt.info/events](https://digitalversorgt.info/events/)

```{python}
#| echo: false
#| output: asis

feed_url = "https://fetchrss.com/feed/aGEABK8A-LZCaGD_7BmngywC.rss"
feed = feedparser.parse(feed_url)
...
### [digital-health-events.de](https://digital-health-events.de/)

```{python}
#| echo: false
#| output: asis

feed_url ="https://fetchrss.com/feed/aGEABK8A-LZCaGEBMIpkMMoC.rss"
feed = feedparser.parse(feed_url)
...
### [e-health-com.de/veranstaltungskalender](https://e-health-com.de/veranstaltungskalender/)

```{python}
#| echo: false
#| output: asis

feed_url ="https://fetchrss.com/feed/aGEABK8A-LZCaGEDQzLOmsSU.rss"
feed = feedparser.parse(feed_url)
